      ...
      <div className="w-[400px] h-[500px] flex flex-col bg-pink-200 rounded-lg  items-center  gap-5">
        ...
        <div className="w-full flex flex-col gap-6 px-10">
          ...
          <div className="w-full flex flex-col gap-1 justify-center items-center">
            <button className="  w-full bg-pink-500 rounded-lg p-2 text-gray-100 hover:shadow-gray-500 hover:shadow-lg hover:cursor-pointer" onClick={handleLogin}>
              {loading ? "submit..." : "submit"}
            </button>
            <p className="text-gray-900">
              create new account{" "}
              <span className="font-bold hover:cursor-pointer" onClick={()=>navigate("/signup")}>sign Up</span>
            </p>
          </div>
        </div>
      </div>
